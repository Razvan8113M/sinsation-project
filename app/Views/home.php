...
<?= $this->section('content')?>
	...
	<div class="banner banner--style2 padding-top bg_img" style="background-image: url(<?= base_url('public/assets/images/banner/bg-2.jpg');?>);">
		<div class="container">
				...
				<div class="row g-0 justify-content-center">
					...
					<div class="col-lg-8 col-12">
						<div class="banner__thumb wow fadeInUp" data-wow-duration="1.5s">
							<img src="<?= base_url('public/assets/images/banner/02.png');?>" alt="banner">
							<div class="banner__thumb--shape">
								<div class="shapeimg shapeimg__one">
									<img src="<?= base_url('public/assets/images/banner/shape/home2/01.png');?>" alt="dating thumb">
								</div>
								<div class="shapeimg shapeimg__two">
									<img src="<?= base_url('public/assets/images/banner/shape/home2/02.png');?>" alt="dating thumb">
								</div>
								<div class="shapeimg shapeimg__three">
									<img src="<?= base_url('public/assets/images/banner/shape/home2/03.png');?>" alt="dating thumb">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="about__left">
							<div class="about__top">
								<div class="about__content">
									<h3>Sinsation</h3>
									<p>Ne găsești, în sfârșit, și ești deja îndrăgostit. Peste 4.000.000 de persoane din întreaga lume au împărtășit deja aceleași experiențe și folosesc sistemul nostru. Să ne alăturați astăzi a devenit mai ușor!</p>
								</div>
							</div>
							<div class="about__bottom">
								<div class="about__bottom--head">
									<h5>Ultimii membri inregistrati</h5>
										...
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												<div class="ragi__thumb">
													<a href="member-single.html"><img src="<?= base_url('public/assets/images/ragi/01.jpg');?>" alt="dating thumb"></a>
												</div>
											</div>
											<div class="swiper-slide">
												<div class="ragi__thumb">
													<a href="member-single.html"><img src="<?= base_url('public/assets/images/ragi/02.jpg');?>" alt="dating thumb"></a>
												</div>
											</div>
											<div class="swiper-slide">
												<div class="ragi__thumb">
													<a href="member-single.html"><img src="<?= base_url('public/assets/images/ragi/03.jpg');?>" alt="dating thumb"></a>
												</div>
											</div>
											<div class="swiper-slide">
												<div class="ragi__thumb">
													<a href="member-single.html"><img src="<?= base_url('public/assets/images/ragi/04.jpg');?>" alt="dating thumb"></a>
												</div>
											</div>
											<div class="swiper-slide">
												<div class="ragi__thumb">
													<a href="member-single.html"><img src="<?= base_url('public/assets/images/ragi/05.jpg');?>" alt="dating thumb"></a>
												</div>
											</div>
											<div class="swiper-slide">
												<div class="ragi__thumb">
					...
					<div class="col">
						<div class="about__right">
							...
							<form action="#">
									...
									<div class="row">
										<div class="col-6">
											...
											<div class="banner__inputlist">
												<select>
													<option>Selecteaza Gen</option>
													<option value="male" selected>Barbat</option>
													<option value="female">Femeie</option>
													<option value="others">Alt gen</option>
												</select>
											</div>
										</div>
										<div class="col-6">
								...
								<button type="submit" class="default-btn reverse d-block"><span>Cauta pertener</span></button>
							</form>
						</div>
					</div>
				</div>
	...
	<div class="member member--style2 padding-top padding-bottom">
		<div class="container">
			<div class="section__header style-2 text-center wow fadeInUp" data-wow-duration="1.5s">
				<h2>Membri inregistrati</h2>
				<p>Învață de la ei și încearcă să ajungi pe această placă. Acest lucru vă va crește cu siguranță vizibilitatea și vă va crește șansele de a vă găsi persoana iubită.</p>
			</div>
			<div class="section__wrapper wow fadeInUp" data-wow-duration="1.5s">
				<ul class="nav nav-tabs member__tab" id="myTab" role="tablist">
					<li class="nav-item" role="presentation">
					  	<button class="nav-link active" id="newest-tab" data-bs-toggle="tab" data-bs-target="#newest" type="button" role="tab" aria-controls="newest" aria-selected="true">Membri noi</button>
					</li>
					<li class="nav-item" role="presentation">
					  	<button class="nav-link" id="activemember-tab" data-bs-toggle="tab" data-bs-target="#activemember" type="button" role="tab" aria-controls="activemember" aria-selected="false">Membri activi</button>
					</li>
					<li class="nav-item" role="presentation">
					  	<button class="nav-link" id="popularmember-tab" data-bs-toggle="tab" data-bs-target="#popularmember" type="button" role="tab" aria-controls="popularmember" aria-selected="false">Membri populari</button>
					</li>
				</ul>
					...
					<div class="tab-pane fade show active" id="newest" role="tabpanel" aria-labelledby="newest-tab">
						<div class="row g-0 justify-content-center">
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/01.jpg')?>" alt="member-img">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/02.jpg')?>" alt="member-img">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/03.jpg')?>" alt="member-img">
										<span class="member__activity"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/04.jpg')?>" alt="member-img">
										<span class="member__activity member__activity--ofline"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/05.jpg')?>" alt="member-img">
										<span class="member__activity"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/06.jpg')?>" alt="member-img">
										<span class="member__activity"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/07.jpg')?>" alt="member-img">
										<span class="member__activity member__activity--ofline"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/08.jpg')?>" alt="member-img">
										<span class="member__activity"></span>
									</div>
									<div class="member__content">
							...
							<div class="member__item">
								<div class="member__inner">
									<div class="member__thumb">
										<img src="<?= base_url('public/assets/images/member/home2/09.jpg')?>" alt="member-img">
										<span class="member__activity member__activity--ofline"></span>
									</div>
									<div class="member__content">
				...
				<div class="text-center mt-4">
					<a href="members.html" class="default-btn"><span>Vezi membri populari</span></a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="col-lg-4 col-12">
						<div class="left">
							<div class="section__header style-2 mb-lg-0 wow fadeInUp" data-wow-duration="1.5s">
								<h2>Gaseste parteneri langa tine</h2>
								<p>Dacă doriți să întâlniți parteneri singuri din aceeasi localitate pentru întâlniri, prietenie sau chiar mai mult, ați venit în locul potrivit.</p>
								<ul>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/01.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">United kingdom</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/02.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">Germany</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/03.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">United states</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/04.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">Brazil</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/05.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">Falkland islands</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/06.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">Portugal</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/07.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">Australia</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/08.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">India</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/09.jpg')?>" alt="lab-trensport"></div>
										<div class="content"><a href="members.html">South Africa</a></div>
									</li>
									<li>
										<div class="thumb"> <img src="<?= base_url('public/assets/images/transport/10.jpg')?>" alt="lab-trensport"></div>
