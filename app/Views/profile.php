 ...
 <div class="pageheader bg_img" style="background-image: url(<?= base_url('public/assets/images/bg-img/pageheader.jpg');?>);">
        <div class="container">
            <div class="pageheader__content text-center">
                <h2>Profil membru <?php echo auth()->user()->username; ?></h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                      <li class="breadcrumb-item"><a href="<?= base_url();?>">Home</a></li>                
                      <li class="breadcrumb-item active" aria-current="page">Profil membru <?php echo auth()->user()->username; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="col-xl-9">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="gt2-tab" data-bs-toggle="tab" data-bs-target="#gt2" type="button" role="tab" aria-controls="gt2" aria-selected="false"><i class="fa-solid fa-users"></i> Profile <span>30</span></button>
                            </li>                           
                            <li class="nav-item" role="presentation">
                    ...
                    <div class="col-xl-6 order-xl-1">
                        <div class="group__bottom--left">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="gt2" role="tabpanel" aria-labelledby="gt2-tab">
                                    <div class="info">
                                        <div class="info-card mb-4">
                                            ...
                                            <?php foreach($selectUser as $user) : ?>  
                                            
                                            <ul class="info-list">
                                                    <li>
                                                        <p class="info-name">Nume</p>
                                                        <p class="info-details">William Smith</p>
                                                    </li>
                                                    <li>
                                                        <p class="info-name">Sunt</p>
                                                        <p class="info-details"><?= $user['gender']?></p>
                                                    </li>
                                                    <li>
                                                        <p class="info-name">Caut</p>
                                                        <p class="info-details"><?= $user['gender']?></p>
                                                    </li>
                                                    <li>
                                                        <p class="info-name">Starea civila</p>
                                                        <p class="info-details"><?= $user['marital_status']?></p>
                                                    </li>
                                                    <li>
                                                        <p class="info-name">Varsta</p>
                                                        <p class="info-details"><?= $user['date_of_birth']?></p>
                                                    </li>                                                    
                                                    <li>
                                                        <p class="info-name">Localitate</p>
                            ...
                            <div class="story__item style2">
                                <div class="story__inner">
                                    <div class="story__thumb position-relative">
                                        <img src="<?= base_url('public/assets/images/member/profile/profile.jpg')?>" alt="dating thumb">
                                    </div>
                                    <div class="story__content px-0 pb-0">
                                        ...
                                        <div class="story__content--author mt-3 pb-2">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/01.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/02.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/03.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/04.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/05.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#groupmodal" data-rel="lightcase:callection"><img src="<?= base_url('public/assets/images/member/profile/06.jpg')?>" alt="dating thumb"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
